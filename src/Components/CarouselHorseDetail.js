...
export function CarouselHorseDetail() {
    return (
        <div className="carouselHorseDetail">
            <Swiper
                ...
                className="mySwiper"
            >
                {/* <SwiperSlide><img alt="Horse 1" src={HorseObj.horseImage} /></SwiperSlide>
                <SwiperSlide><img alt="Horse 2" src={HorseObj.horseImage} /></SwiperSlide>
                <SwiperSlide><img alt="Horse 3" src={HorseObj.horseImage} /></SwiperSlide>
                <SwiperSlide><img alt="Horse 4" src={HorseObj.horseImage} /></SwiperSlide> */}
            </Swiper>
        </div>
