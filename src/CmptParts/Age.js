        ...
        <div className="filter_cont_age_exterior">
            ...
            <div className="filter_cont_age">
                ...
                <input id="maxAge" type="number" min="1" max="35" placeholder="max"
                    onWheel={(e) => e.target.blur()}
                    onChange={()=> {
                        if(document.getElementById("maxAge").value < document.getElementById("minAge").value) {
                            document.getElementById("maxAge").value = Number(document.getElementById("minAge").value)+1;
                        }
                    }} 
                />
            </div>
