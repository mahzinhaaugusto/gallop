        ...
        <div className="myHorses">
            ...
            <div className="myHorses_cont_master">
                <div className="myHorses_cont_master_header">
                    ...
                    <Button title="Add Horse +" className="myHorses_cont_master_btn" onClick={redirectAdd} />
                </div>
                    ...
                    <div className="myHorses_cont">
                        <div className="myHorses_cont_header">
                            <div className="myHorses_cont_header_back">
                                ...
                                />
                                <p className="myHorses_cont_header_text" onClick={backToMain}>(CALCULATE) Horses</p>
                            </div>
            ...
            {myHorse.map((horse, i) => <div key={i} className="horseCard_myHorses">
                <div className="horseCard_myHorses_cont">
                    ...
                    <div className="horseCard_myHorses_cont_details">
                        <h3 id="horseCard_myHorses_cont_details_name">{horse.horseName}</h3>
                        <div className="horseCard_myHorses_cont_details_label">
                            <h4 id="horseCard_myHorses_cont_details_labels">{horse.breed.charAt(0).toUpperCase() + horse.breed.slice(1)} | {horse.gender.charAt(0).toUpperCase() + horse.gender.slice(1)} | {horse.horseAge} yr(s) old </h4>
                        </div>
                        <div className="horseCard_myHorses_cont_details_btns">
                            <button id="horseCard_myHorses_cont_details_editBtn" type="button" onClick={editHorse}>
                                EDIT
                                <img src={Edit} alt="" />
                            </button>
                            <button id="horseCard_myHorses_cont_details_deleteBtn" type="button" onClick={deleteHorse}>
                                DELETE
                                <img src={Trash} alt="" />
                            </button>
                        </div>
