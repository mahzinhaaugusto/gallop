...
export function AddHorse() {
    ...
    const clickPlus = () => { console.log("works") }
    const clickSave = () => { console.log("works") }
    const clickCancel = () => { console.log("works") }
            ...
            <div className="addHorse_cont">
                ...
                <div className="addHorse_cont_basics">
                    ...
                    <div className="addHorse_cont_basics_upload">
                        <div className="addHorse_cont_basics_upload_thumbnail">
                            <h4>Thumbnail</h4>
                            <textarea name="thumbnail" id="thumbnail" cols="50" rows="6">Upload Thumbnail</textarea><div onClick={clickPlus}><img src={Plus} /></div>
                        </div>
                        <div className="addHorse_cont_basics_upload_media">
                            <h4>Media *</h4>
                            <textarea required name="media" id="media" cols="50" rows="6">You can upload x photos</textarea><div onClick={clickPlus}><img src={Plus} /></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="addHorse_cont_aboutOwner">
                    ...
                    <div className="addHorse_cont_aboutOwner_location">
                        <h4>Location *</h4>
                        <input required name="ownerLocation" id="ownerLocation" type="text"></input>
                    </div>
